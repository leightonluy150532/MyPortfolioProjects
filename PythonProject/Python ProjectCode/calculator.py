...
class Calculator:
    def __init__(self,master):
        ...
        self.entry_value=''
        Entry(width=25,bg='#fff', font=('Arial bold', 28),textvariable=self.equation).place(x=0,y=0)
        ...
        Button(width=11,height=4,text='<=',relief='flat',bg='lightblue',command=self.backspace).place(x=356,y=50)
